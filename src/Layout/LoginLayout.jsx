        ...
        <div className=" flex">
            ...
            <div className="hidden md:flex flex-col p-12 bg-gray-50 w-1/2">
                ...
                <div className="flex flex-col justify-center max-w-xl mx-auto items-center">
                    ...
                    {/* Card 5 */}
                    {/* <div className={cardClass}>
                        <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-purple-100 text-purple-500 text-xl">
                            <FaLightbulb />
                        </div>
                        <p className="ml-4 text-gray-700">
                            Discover new insights, tips, and resources from experts.
                        </p>
                    </div> */}
                </div>
